...
$(".rules").click(() => {
    ...
    $(".large").html('This is jeopardy: answer the questions correctly to recieve points. </br> Answer incorrectly and lose points.</br> Once you answer all the questions click the "Answered all the questions! Did I win?" button to see if you won! </br> Score above zero and win! Score 0 and tie. </br> Score below 0 and lose.')
})